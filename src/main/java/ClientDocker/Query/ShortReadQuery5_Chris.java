                        ...
                        if(this.neighbors.size() > 0) {
                            ...
                            for(int i = 0; i < this.neighbors.size(); ++i) {
                                //if(i!=0){
                                    ...
                                    if(i==1){
                                        future = executor.submit(new gRPC(serverSubquery, 1, 2, this.neighbors.get(i), randArray[j], this.queryID, this.temp_message_table_name, this.idToChannel));
                                    }else{
                                        future = executor.submit(new gRPC(serverSubquery, 1, this.localId, this.neighbors.get(i), randArray[j], this.queryID, this.temp_message_table_name, this.idToChannel));
                                    }
                ...
                if(personSet.next()) {
                    ...
                    for(int i = 0; i < this.neighbors.size(); ++i) {
                        //if(i != 0){
                            ...
                            if(i==1){
                                future = executor.submit(new gRPC(person_subquery, 2, 2, this.neighbors.get(i), randArray[j], this.queryID, this.temp_person_table_name, this.idToChannel));
                            }else{
                                future = executor.submit(new gRPC(person_subquery, 2, this.localId, this.neighbors.get(i), randArray[j], this.queryID, this.temp_person_table_name, this.idToChannel));
                            }
